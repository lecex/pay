...
type Icbc struct {
	...
	SubMerId       string `protobuf:"bytes,8,opt,name=sub_mer_id,json=subMerId,proto3" json:"sub_mer_id,omitempty"`
	Fee            int64  `protobuf:"varint,9,opt,name=fee,proto3" json:"fee,omitempty"`
	Sandbox        bool   `protobuf:"varint,10,opt,name=sandbox,proto3" json:"sandbox,omitempty"`
}
...
func (m *Icbc) GetSubMerId() string {
	if m != nil {
		return m.SubMerId
	}
	return ""
...
var fileDescriptor_2f7e909880fb5ba3 = []byte{
	...
	,
}
...
func (m *Icbc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubMerId) > 0 {
		i -= len(m.SubMerId)
		copy(dAtA[i:], m.SubMerId)
		i = encodeVarintConfig(dAtA, i, uint64(len(m.SubMerId)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.MerId) > 0 {
...
func (m *Icbc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubMerId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SubMerId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Fee", wireType)
